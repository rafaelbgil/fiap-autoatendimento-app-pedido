"""
Django settings for autoatendimento project.
...
ROOT_URLCONF = 'autoatendimento.urls'
...
WSGI_APPLICATION = 'autoatendimento.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Api Pedido de lanchonete',
